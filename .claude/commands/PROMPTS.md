...
**CRITICAL REMINDERS:**
1. READ FIRST: memory/TRADING-STRATEGY.md, memory/TRADE-LOG.md (tail -20), memory/RESEARCH-LOG.md (tail -5)
2. API credentials: ALPACA_API_KEY, ALPACA_SECRET_KEY, GEMINI_API_KEY from environment variables ONLY
3. WRITE AT END: Append new entry to memory/RESEARCH-LOG.md
...
**CRITICAL REMINDERS:**
1. READ FIRST: memory/RESEARCH-LOG.md (today's entry), memory/CONSTRAINTS.md
2. API credentials: ALPACA_API_KEY, ALPACA_SECRET_KEY from environment variables ONLY
3. WRITE AT END: Append to memory/TRADE-LOG.md, memory/DAILY-SUMMARY.md
...
**CRITICAL REMINDERS:**
1. READ FIRST: memory/CONSTRAINTS.md, memory/RESEARCH-LOG.md (today's entry), memory/TRADE-LOG.md
2. API credentials: ALPACA_API_KEY, ALPACA_SECRET_KEY from environment variables ONLY
3. WRITE AT END: Append to memory/TRADE-LOG.md, memory/DAILY-SUMMARY.md
...
**CRITICAL REMINDERS:**
1. READ FIRST: memory/TRADING-STRATEGY.md, memory/TRADE-LOG.md (tail -20), memory/RESEARCH-LOG.md
2. API credentials: ALPACA_API_KEY, ALPACA_SECRET_KEY from environment variables ONLY
3. WRITE AT END: Append to memory/TRADE-LOG.md, memory/DAILY-SUMMARY.md (only if actions taken)
...
**CRITICAL REMINDERS:**
1. READ FIRST: memory/TRADE-LOG.md (tail -5 for yesterday's EOD), memory/CONSTRAINTS.md
2. API credentials: ALPACA_API_KEY, ALPACA_SECRET_KEY from environment variables ONLY
3. WRITE AT END: Append to memory/TRADE-LOG.md (EOD snapshot), memory/DAILY-SUMMARY.md
...
**CRITICAL REMINDERS:**
1. READ FIRST: memory/TRADING-STRATEGY.md, memory/CONSTRAINTS.md, memory/TRADE-LOG.md, memory/RESEARCH-LOG.md, memory/WEEKLY-REVIEW.md
2. API credentials: None needed for WebSearch queries (Claude built-in)
3. WRITE AT END: Append to memory/WEEKLY-REVIEW.md, memory/DAILY-SUMMARY.md (recap)
